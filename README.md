**Проект закрыт и архивирован, он пересоздается в виде двух новых проектов - отдельно препроцессоров и отдельно утилит работы с магнитофонным портом и файлами для эмулятора GID**\
Репозитории новых проектов:\
https://github.com/tereshenkovav/BkTapePortUtils \
https://github.com/tereshenkovav/BkPreprocessors

# Информация по архивной версии проекта
